...
const PartyDetails = () => {
    ...
    const handleDownloadPDF = () => {
        ...
        doc.setFillColor(22, 163, 35);   // green background
        doc.rect(0, 0, pageWidth, 30, "F"); // filled rectangle for header
        ...
        // ===== Empty Table (autoTable required) =====
        autoTable(doc, {
            startY: 55,
            theme: "striped",
            headStyles: { fillColor: [22, 163, 35], textColor: 255 },
            bodyStyles: { textColor: 0 },
            styles: { halign: "center" }, // header & body centered
        });
    ...
    const handleDeleteTransaction = (transactionId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`http://localhost:3000/partys/${id}/transactions/${transactionId}`, {
                    method: "DELETE"
                })
                    .then(res => res.json())
                    .then(() => {
            ...
            <div className="bg-base-100 rounded-3xl shadow-xl overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <table className="table w-full text-center">
                        ...
                        <tbody>
                            {[...(party?.transactions || [])]
                                .sort((a, b) => new Date(b.date) - new Date(a.date)) // 🔥 Date wise
                                .map((t) => (
