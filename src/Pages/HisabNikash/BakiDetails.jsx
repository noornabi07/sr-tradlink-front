...
const BakiDetails = () => {
  ...
  const handleUpdateTransaction = () => {
    ...
    fetch(
      `${API_BASE_URL}/clients/${id}/transactions/${editingTransaction._id}`,
      {
        method: "PUT",
        headers: {
          "content-type": "application/json",
    ...
    <div className="max-w-6xl mx-auto mt-24 px-4">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-linear-to-r from-green-600 to-emerald-500 text-white font-bold hover:scale-105 transition"
        >
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="w-full mt-6 py-3 rounded-xl bg-linear-to-r from-green-600 to-emerald-500 text-white font-bold text-lg hover:scale-105 transition"
            >
              সংরক্ষণ করুন
            </button>
