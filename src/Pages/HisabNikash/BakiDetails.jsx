...
const BakiDetails = () => {
    ...
    return (
        ...
        rounded-3xl p-8 shadow-xl text-white mb-10">
                <h1 className="text-4xl font-bold">{user.name}</h1>
                <p className="mt-2 opacity-90">Baki Account Details</p>
            </div>

            {/* Summary Cards */}
            <div className="grid md:grid-cols-3 gap-6 mb-12">
                <div className="bg-base-100 rounded-2xl p-6 shadow-lg text-center">
                    <p className="text-gray-500 font-bold">Total Kroy</p>
                    <h2 className="text-3xl font-bold text-green-700 mt-2">
                        ৳ {totalKroy}
                    </h2>
                </div>
                ...
                <div className="bg-base-100 rounded-2xl p-6 shadow-lg text-center">
                    <p className="text-gray-500 font-bold">Total Joma</p>
                    <h2 className="text-3xl font-bold text-blue-600 mt-2">
                        ৳ {totalJoma}
                    </h2>
                </div>
                ...
                <div className="bg-base-100 rounded-2xl p-6 shadow-lg border-2 border-red-500 text-center">
                    <p className="text-gray-500 font-bold">Current Pawna</p>
                    <h2 className="text-3xl font-bold text-red-600 mt-2">
                        ৳ {totalKroy - totalJoma}
                    </h2>
                </div>
                    ...
                    <table className="table w-full text-center">
                        ...
                        <tbody>
                            {user.transactions.map((t, index) => {
                                runningKroy += t.kroy;
                                runningJoma += t.joma;
                                const currentPawna = runningKroy - runningJoma;
