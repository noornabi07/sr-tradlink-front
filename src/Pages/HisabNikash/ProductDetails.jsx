...
//   const currentTransactions = (product.transactions || []).slice(indexOfFirst, indexOfLast);
//   const totalPages = Math.ceil((product.transactions || []).length / transactionsPerPage);
...
//     // 🔜 future: push into product.transactions / save backend
...
//         >
//           <FiPlusCircle className="text-xl" /> নতুন Transaction যোগ করুন
//         </button>
//       </div>
